                ...
                <div className="card-body text-center">
                  ...
                  <div className="form-group">
                    <div className="input-group">
                      ...
                      <input type="text" className="form-control" placeholder="Username" ref={rUsername}/>
                    </div>
                  </div>
                  <div className="form-group">
                    <div className="input-group">
                      ...
                      <input type="text" className="form-control" placeholder="Password" ref={rPassword} />
                    </div>
                  </div>
                  ...
                  <p className="small text-secondary">By clicking the login button you are accepting our Policies and Terms of Use</p>
                  <input value="Sign In" type="submit" className="btn btn-primary btn-block mt-3" onClick={() => login()} />
                </div>
              </div>
            </div>
          </div>
