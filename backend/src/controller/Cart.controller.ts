...
export const create = HttpFunction("POST", "System was unable to create a cart.", (req, res) => {
...
export const verify = HttpFunction("ALL", "System was unable to verify the cart session.", (req, res, next) => {
...
const test = HttpFunction("ALL", "System is testing", create);

export const checkout = HttpFunction("POST", "System was unable to checkout your order", (req, res, next) => {
...
export const listProducts = HttpFunction("GET", "System was unable to list the items in the cart.", (req, res) => {
  ...
  const productBody: IProduct.ExistingBody[] = products.map(cur => cur.toPrimitiveObj());
  res.send({ success: true, products: productBody });
  return;
});

export const search = HttpFunction("GET", "System was unable to find any cart at all.", (req, res) => {
