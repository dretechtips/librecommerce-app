...
export const search = HttpFunction("GET", "System couldn't find the bill for the date range.", (req, res) => {
...
export const searchToday = HttpFunction("GET", "System couldn't find the bill for today.", (req, res) => {
