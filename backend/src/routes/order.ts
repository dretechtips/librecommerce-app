...
AdminRoute.delete("/complete", (req, res) =>
  OrdersController.complete(req, res)
);
AdminRoute.patch("/update", (req, res) => OrdersController.update(req, res));
AdminRoute.get("/hold/list", (req, res) =>
  OrdersController.getHoldList(req, res)
);
AdminRoute.post("/hold/add", (req, res) => OrdersController.hold(req, res));
AdminRoute.delete("/hold/delete", (req, res) =>
  OrdersController.unhold(req, res)
);
